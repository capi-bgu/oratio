...
class PynputKeyboardCollectorStub(DataCollector):
    class Event:
        pass
    ...
    def __init__(self):
        ...
        self.data_path = os.path.join(test_dir, 'test_data', 'pynput_kb', 'raw_data')
...
if __name__ == '__main__':
    keyboard_collector_stub = PynputKeyboardCollectorStub()
